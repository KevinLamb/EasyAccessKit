...
namespace DemoEasyAccess.Carousel
{
    public class CarouselController : Controller
    {
        public IActionResult Index()
        {
            ...
            item1.ImageUrl = "/images/banner1.svg";
            item1.Title = "Image 1";
            ...
            CarouselItem item2 = new CarouselItem("/images/banner2.svg", "Image 2", "This is image 2", "There is no actual image but this is the image 1 alt text");
